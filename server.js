...
// FIX: This endpoint was missing — Msg Injector was calling it and getting 404/Failed
app.post('/api/send-message', async (req, res) => {
    ...
    // Broadcast 'injected_message' via SSE — main-bot listens for this
    // and displays the message to the targeted user on their screen
    broadcastSSE('injected_message', {
        userName,
        message,
        type: msgType,
        timestamp: ts
